...
<div x-data="{ show : false , name : '{{ $name }}' }" 
    ...
    {{-- Modal Body --}}
    <div class="bg-white rounded m-auto fixed inset-0 max-w-7xl overflow-y-auto" style="max-height:600px">
        @if (isset($title))
            <div class="px-4 py-4 flex items-center justify-between border-b border-gray-300">
